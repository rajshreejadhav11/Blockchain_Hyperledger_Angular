...
export class ContractComponent implements OnInit {
  ...
  researchInst = new FormControl('', Validators.required);
  ...
  constructor(public serviceContract: ContractService, fb: FormBuilder) {
    this.myForm = fb.group({
      ...
      researchInst: this.researchInst,
  ...
  getForm(id: any): Promise<any> {
    ...
    .then((result) => {
      ...
      if (result.marketplace) {
        formObject.marketplace = result.marketplace;
      } else {
        formObject.marketplace = null;
      }

      if (result.researchInst) {
        formObject.researchInst = result.researchInst;
      } else {
        formObject.researchInst = null;
      }
